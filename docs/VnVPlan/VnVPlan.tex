...
1. \textbf{Usability} - Covers the users interactions with the note taking system. (SRS NF214, NF217)

2. \textbf{Portability}  - Covers the portability of the app to work and behave the same on different operating systems. (NF-213)

3. \textbf{Performance}  - Covers the performance of the app while making and editing notes. (SRS NF211, NF218)

4. \textbf{Consistency of Open and Closed Notes} - Covers data not being lost or corrupted.  (SRS NF212, NF215, NF216)



\subsubsection{Area of Testing 1 - Usability}
...
\subsubsection{Area of Testing 2 - Portability}
...
\subsubsection{Area of Testing 3 - Perfomance of Editing and Canvas Operations}
...
\subsubsection{Area of Testing 4 - Consistency of Open and Closed Notes}
