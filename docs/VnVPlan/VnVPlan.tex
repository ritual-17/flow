...
\begin{enumerate}
  ...
  \begin{itemize}
    \item Chengze - To learn automated testing pipelines, I will follow GitHub 
    Actions tutorials and experiment with sample CI/CD workflows. I’ll also watch 
    YouTube and Udemy videos on setting up test automation. These two approaches provide both
    theoretical knowledge and practical experience, which I find effective for learning new tools. 
    \item Ethan -
    \item Hussain -
    \item Jeffrey -
    \item Kevin -
