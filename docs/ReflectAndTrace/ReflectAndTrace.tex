...
\midrule
228 & Peer & "Nonfunctional tests lack measurable criteria" & NF tests list in the 
VnV plan were made a bit more specific \\
231 & Peer & NFR Tests 211 and 218 both measure same performance and latency 
...
232 &Peer & Usability survey lists questions but doesn't specify concrete success metrics
& Survey questions have been updated and refined \\
233 &Peer & Testing tools not specified & No change made in documentation. 
Jest and Playwright were the mentioned tools in VnV Plan, justification also provided \\
234 &Peer & Usability survey lacks measurable criteria & survey questions have been 
updated and refined \\
\bottomrule
\end{tabularx}
...
Issue Number & Reviewer & Given Feedback (Summarized) & Change made  \\
\midrule
529 & TA & list of tables is missing in VnV Plan & list of tables added back to document \\
529 & TA & NFR testing not specific enough. For example, NF216 is a code review
 on parts that use network data. What kind of code review is expected? & NF tests, 
 including NF216, were made more specific \\
529 & TA & Redundancy. For example, F213 is a relatively straightforward test to include. 
It could feasibly be included into "Area of Testing1". & Added Functional test for
F213 \\
529 & TA & Be more specific and intentional about nondynamic testing. Provide 
