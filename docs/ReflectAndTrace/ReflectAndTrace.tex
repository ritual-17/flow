...
\midrule
Peer & No discussion of timeline to implement M3 & Added description of timeline 
for M3 implementation \\
Peer & Code coverage short of planned target, with no explanation & Added 
explanation addressing the low code coverage \\
Peer & Unit test section has no reults summary & No changes made to the 
documentation. Tests were described in the VnV Plan \\
Peer & Only two usability test participants, with no justification & This has been
addressed. A plan and desire for an increase in sample size was mentioned  \\
Peer & Inconsistent usability conclusions & No changes made to the documentation.
An explanation to the peer on the consistency of our conclusions was provided \\
Peer & Flow's comparison to existing implementation lacked support & The validity
of Flow over other solutions was emphasized with more detailed justifications. \\
TA & Section 3 and 4 does not mention what requirements are involved in the tests 
& explicitly mentioned which requirements involved in tests  \\
TA & Usability description lacked explanation and/or acknowledgement of small 
sample size & This has been addressed. A plan and desire for an increase in sample
size was mentioned  \\
TA & Performance data could be presented better & improved presentation of 
