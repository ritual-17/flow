...
{project-title} than with other existing solutions outlined in <<G.1>>. For the
purposes of this document, proficiency can be defined as completion of the user manual and 10+
