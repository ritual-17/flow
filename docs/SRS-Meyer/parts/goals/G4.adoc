...
The user can insert predefined geometry as outlined in <<S.3>>. Geometry can be 
moved and resized and custom geometry can be created. A combination of geometry 
can be selected and saved for reuse by the user. Users can define custom keyboard
shortcuts mapped to custom geometry for quick insertion.
