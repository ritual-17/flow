...
. [[NF231]] **Performance**: Rendering shall maintain a minimum of 60 frames per second for at least 95% of the time during continuous user interaction (e.g., typing, dragging, or panning) on a canvas containing up to 100 elements. (NF231)
...
. [[NF218]] **Large-document responsiveness**: The application (input handling, command processing, and rendering) shall remain responsive with documents containing more than 500 on-canvas elements. (NF218)
