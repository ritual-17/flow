...
. [[NF231]] **Performance**: Rendering shall maintain a minimum of 60 frames per second for at least 95% of the active usage time under typical workloads. (60fps is targeted because it is the baseline for smooth animation in web and multimedia applications) (NF231)
...
_Note: This section is informational and does not correspond to a system component. It supplements sections S.2.1–S.2.6 by making component inputs/outputs explicit and classifying requirements by likelihood of change, so an external team could design, build, and test from this document._
