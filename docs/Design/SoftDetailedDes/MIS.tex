...
\begin{itemize}
\item input: file\_path The file path
...
\item output: parded_input, tuple of command which would be used by the Geometry State Mutator Module \ref{Geometry State Mutator Module}
\end{itemize}
