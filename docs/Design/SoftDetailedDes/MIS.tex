...
\item output: Outputs current status of the program ex waiting fr input, rendering etc. 
\end{itemize}
...
Command names/ids ex ctrl + s -> <C-s>, d + d -> "dd"
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
{parse\_commands} & keyboard\_inputs, mouse\_inputs & parsed_input & - \\
\hline
\end{tabular}
\end{center}
