...
\item output: parsed_input, tuple of command which would be used by the Geometry State Mutator Module \ref{Geometry State Mutator Module}
\end{itemize}
...
\begin{itemize}
\item input: shape\_type string containing type of shape
\item input: new_points set of points used for creating the shape
