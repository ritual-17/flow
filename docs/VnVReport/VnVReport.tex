...
◦ May  require  exporting  and  importing  images  into  a  separate  text  editor  for  note-taking  (e.g.
Draw.io)
• Text-based diagram languages (e.g. Mermaid, PlantUML)
◦ Separate  definition  from  rendering,  forcing  users  to  manage  an  inefficient  write-compile-insert
cycle
◦ Requires integration with another text editor for note-taking text
• Document markup languages (e.g. LaTeX, Typst)
◦ Limited  to  a  more  traditional  page  format  rather  than  infinite  workspace  like  OneNote  for
example
