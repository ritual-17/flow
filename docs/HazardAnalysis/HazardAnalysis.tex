...
Potentially user to pin diagram positions & SR-RENDER-1 \\ \midrule
...
error, preserve raw text and do not delete it & SR-PARSE-1 \\ \midrule
...
tests for loading after saving & SR-LOAD-1 \\ \midrule
...
tests for save routines & SR-SAVE-1 \\ \midrule
...
complexity of custom shapes (e.g. no nested shapes); & SR-CUSTOM-1 \\
\midrule
...
loading, and execution; & SR-MACRO-1 \\ \midrule
