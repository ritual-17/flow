...
\begin{itemize}
  ...
  \item These shapes can be manipulated within the GUI, including them being selected,
  moved, and resized using keyboard commands.
...
shapes, and manipulating them, all using only keyboard inputs. Successful 
completion of these tasks will confirm the technical feasibility of the core
functionality of the application. It would show that users can effectively create
and modify geometric elements within a GUI for their notes. Further evaluation of
efficiency and intuitiveness can be done once this core functionality is proven.
