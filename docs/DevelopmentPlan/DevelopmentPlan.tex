...
Meet 1-3 times per week with one in person meeting reoccurring at the same time every week.

\wss{If the meeting is a physical location (not virtual), out of an abundance of
caution for safety reasons you shouldn't put the location online}

We will meet at a previously agreed upon location that will be discussed privately.
...
Some extra meetings will be virtual.
...
We are using a discord server along with git hub issues to track progress. 
