...
% \begin{itemize}
  ...
  such as bug, feature, meeting, etc. This will help in organizing and prioritizing the work that needs to be done. Assigning of issues will
  be done where necessary to track who is responsible for what.
  \\
  \\
  GitHub Actions will be used for CI/CD mainly for linting and running tests. Whenever a pull request is created, the CI/CD pipeline will 
  automatically run the linter and any tests that have been written. This will help catch any problems early, making sure any code merged is
  the correct format.
